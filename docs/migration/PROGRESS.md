...
**Última sesión completada:** SESSION-MIG-01 — Pre-flight audit + backup + sincronización (2026-04-24)
**Próxima sesión:** SESSION-MIG-02 — Subtree merge + cleanup submodule roto
**Siguiente prompt:** `docs/migration/prompts/SESSION-MIG-02.md`
...
_(ninguno para SESSION-MIG-02 — todo listo)_
